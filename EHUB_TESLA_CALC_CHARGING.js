...
if(tesla_needs_charging == true){
    ...
    if(tesla_soc < 20){ // Always charge the car up to minimum 20%
        ...
        tesla_charge_on = 2;    // 2 = Use grid power
        asked_load_current = 16;
        messageToTeslaUser = "0b. Cheap hours. Just charge! SOC: "+ tesla_soc + ". Asked current:" + asked_load_current + " adjBuyPriceNow:" + adjBuyPriceNow + ". tesla_soc " + tesla_soc + ". Car needs: " + tesla_charge_limit + "hours_to_fill_up_car: " + hours_to_fill_up_car; 
